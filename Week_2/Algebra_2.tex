...
%\firstpageheadrule
\runningheader{\footnotesize Upper Secondary Mathletics}{\footnotesize Test 1, Page 
\thepage\ of 
\numpages}{\footnotesize September 29, 2017}
%\firstpagefooter{}{}{}
%\runningfooter{}{}{}
...
\begin{center}\centering
    ...
    Mathletics for Upper Secondary\\
%     \textbf{Class Test}
\end{center}

\begin{center}
  \fbox{\fbox{\parbox{6in}{
  Read the questions \emph{carefully}. Answer the questions in the spaces 
provided on the question sheets. If you run out of room for an answer, continue 
on the back of the page. }}}
\end{center}
\vspace{0.3in}
\makebox[\textwidth]{\textbf{Student's Name}:\enspace\hrulefill}
\vspace*{0.2in}
\makebox[\textwidth]{Instructor's Name: Nana Baah Akuffu\enspace\hfill}\\
\textbf{Time Allowed: 10 minutes}
	...
	\ifprintanswers
	  \begin{solution}\\
		\begin{align*}
		  ...
		  x &= \sqrt{y^2 - 4}
		\end{align*}
		\textbf{Answer: }\fbox{$x = \sqrt{y^2 - 4}$}
	  \end{solution}
	\else
	  \makeemptybox{1.33in}
	\fi
	...
	\ifprintanswers
	  \begin{solution}\\
		...
		\begin{align*}		  
		  ...
		  &= 1 - \frac{1}{x}
		\end{align*}
		\textbf{Answer: }\fbox{$1 - \dfrac{1}{x} \quad \text{or} \quad \dfrac{x-1}{x}$}
	  \end{solution}
	\else
	  \makeemptybox{1.33in}
	\fi
